...
<template>
  <div class="w-full flex flex-col items-center justify-center min-h-[70vh] text-center gap-6 md:gap-12 group">
    ...
    <div class="flex flex-col items-center gap-4 md:gap-6 mt-6 md:mt-12 w-full max-w-sm px-4">
      <button 
        @click="start"
    ...
    <!-- Features badge -->
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 mt-8 md:mt-20 opacity-40 group-hover:opacity-100 transition-opacity">
       <div 
